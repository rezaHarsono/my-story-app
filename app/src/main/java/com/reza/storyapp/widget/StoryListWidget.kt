...
class StoryListWidget : AppWidgetProvider() {
    ...
    companion object {
        private const val TOAST_ACTION = "com.reza.storyapp.TOAST_ACTION"
        const val EXTRA_ITEM = "com.reza.storyapp.EXTRA_ITEM"
        ...
        fun notifyDataSetChanged(context: Context) {
            ...
            val appWidgetIds = appWidgetManager.getAppWidgetIds(
                ComponentName(context, StoryListWidget::class.java)
            )
            appWidgetManager.notifyAppWidgetViewDataChanged(appWidgetIds, R.id.stack_view)
            val intent = Intent(context, StoryListWidget::class.java).apply {
